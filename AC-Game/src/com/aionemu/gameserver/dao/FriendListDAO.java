...
/**
 * @author Ben
 * @modified Yon (Aion Reconstruction Project) -- added {@link #updateMemo(Player, Player, String)}.
 */
public abstract class FriendListDAO implements DAO {
	...
	/**
	 * Adds a memo for <code>player</code>'s friend list to describe <code>friend</code>.
	 * This memo is only visible for the player that set it.
	 * 
	 * @param player
	 * @param friend
	 * @param memo
	 * @return
	 */
	public abstract boolean updateMemo(final Player player, final Friend friend, final String memo);
