...
public abstract class AbstractCronTask implements Runnable {
	...
	/**
	 * The same as a milliseconds left, but any extended class may specify a little delay. if delay is not needed then it's simple "runTime" minus
	 * "now" function
	 */
...
//	public final void forcedRun() { //FIX-ME: Remove
//		preRun();
//		
//		executeTask();
//		saveNextRunTime();
