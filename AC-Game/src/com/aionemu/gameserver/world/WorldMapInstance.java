 ...
 *
 * @author -Nemesiss-
 * @modified Yon (Aion Reconstruction Project) -- Added {@link #flagvars}, and corresponding methods
 * ({@link #setWorldFlagvar(FlagvarIndicator)}, {@link #unsetWorldFlagvar(FlagvarIndicator)},
...
public abstract class WorldMapInstance {
	...
	/**
	 * Flagvars for the Mechanics System.
	 */
	...
	public final boolean setWorldFlagvar(FlagvarIndicator flagvarIndicator) {
	...
	public final boolean unsetWorldFlagvar(FlagvarIndicator flagvarIndicator) {
		synchronized (flagvars) {
			if (flagvars[flagvarIndicator.ordinal()]) {
	...
	public final boolean isWorldFlagvar(FlagvarIndicator flagvarIndicator, boolean isSet) {
		synchronized (flagvars) {
			return flagvars[flagvarIndicator.ordinal()] == isSet;
		}
	}
}
