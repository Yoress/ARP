 ...
 * 
 * @author -Nemesiss-
 * @modified Yon (Aion Reconstruction Project) -- Added {@link #checkActiveness()} and {@link #siegeActivate()}.
 */
public class MapRegion {
	...
	/**
	 * This is only meant for fortress sieges; it will activate this region and its neighbors.
	 */
	public final void siegeActivate() {
		checkActiveness(true);
	}
	
	public final void checkActiveness() {
