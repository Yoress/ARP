 ...
 */
public class DecreaseIntvarCondition extends Condition {
	...
	public DecreaseIntvarCondition(IntvarIndicator intvarIndicator, int lowerBound, int upperBound, boolean beTrueOnlyWhenHitTheBound) {
		super(ConditionType.decrease_intvar);
	...
	public boolean equals(Object obj) {
		if (obj instanceof DecreaseIntvarCondition) {
			DecreaseIntvarCondition o = (DecreaseIntvarCondition) obj;
