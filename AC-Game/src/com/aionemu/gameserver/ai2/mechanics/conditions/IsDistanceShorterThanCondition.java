 ...
 */
public class IsDistanceShorterThanCondition extends Condition {
	
	final public ObjIndicator who;
	
	final public int distance;
	
	public IsDistanceShorterThanCondition(ObjIndicator who, int distance) {
		super(ConditionType.is_distance_shorter_than);
		this.who = who;
	...
	public boolean equals(Object obj) {
		if (obj instanceof IsDistanceShorterThanCondition) {
			IsDistanceShorterThanCondition o = (IsDistanceShorterThanCondition) obj;
