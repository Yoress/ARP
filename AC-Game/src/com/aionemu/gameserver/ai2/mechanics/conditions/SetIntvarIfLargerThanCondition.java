 ...
 */
public class SetIntvarIfLargerThanCondition extends Condition {
	...
	public SetIntvarIfLargerThanCondition(IntvarIndicator intvarIndicator, int intvarToSet, int comparand) {
		super(ConditionType.set_intvar_if_larger_than);
	...
	public boolean check(MechanicEvent event, AbstractMechanicsAI2 ai) {
		return ai.compareAndSetIntvar(intvarIndicator, false, comparand, intvarToSet);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof SetIntvarIfLargerThanCondition) {
			SetIntvarIfLargerThanCondition o = (SetIntvarIfLargerThanCondition) obj;
