 ...
 */
public class UnsetWorldFlagVarCondition extends Condition {
	
	final public FlagvarIndicator flagvarIndicator;
	
	public UnsetWorldFlagVarCondition(FlagvarIndicator flagvarIndicator) {
		super(ConditionType.unset_world_flag_var);
	...
	public boolean check(MechanicEvent event, AbstractMechanicsAI2 ai) {
		return World.getInstance()
				...
				.unsetWorldFlagvar(flagvarIndicator);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof UnsetWorldFlagVarCondition) {
			UnsetWorldFlagVarCondition o = (UnsetWorldFlagVarCondition) obj;
