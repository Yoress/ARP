 ...
 */
public class UnsetFlagVarCondition extends Condition {
	
	final public FlagvarIndicator flagvarIndicator;
	
	public UnsetFlagVarCondition(FlagvarIndicator flagvarIndicator) {
		super(ConditionType.unset_flag_var);
		this.flagvarIndicator = flagvarIndicator;
	}
	
	@Override
	public boolean check(MechanicEvent event, AbstractMechanicsAI2 ai) {
		return ai.unsetFlagvar(flagvarIndicator);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof UnsetFlagVarCondition) {
			UnsetFlagVarCondition o = (UnsetFlagVarCondition) obj;
