 ...
 */
public class SetWorldFlagVarCondition extends Condition {
	
	final public FlagvarIndicator flagvarIndicator;
	
	public SetWorldFlagVarCondition(FlagvarIndicator flagvarIndicator) {
		super(ConditionType.set_world_flag_var);
	...
	public boolean check(MechanicEvent event, AbstractMechanicsAI2 ai) {
		return World.getInstance()
				...
				.setWorldFlagvar(flagvarIndicator);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof SetWorldFlagVarCondition) {
			SetWorldFlagVarCondition o = (SetWorldFlagVarCondition) obj;
