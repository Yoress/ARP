 ...
 */
public class GiveItemByUserIndicatorAction extends Action {
	
	final public UserIndicator receiver;
	...
	public GiveItemByUserIndicatorAction(UserIndicator receiver, int itemId, int min, int max) {
		super(ActionType.give_item_by_user_indicator);
	...
	public void performAction(MechanicEvent event, AbstractMechanicsAI2 ai) {
		...
		VisibleObject obj = event.getObjectIndicator(receiver.getObjIndicator(), ai);
	...
	public boolean equals(Object obj) {
		if (obj instanceof GiveItemByUserIndicatorAction) {
			GiveItemByUserIndicatorAction o = (GiveItemByUserIndicatorAction) obj;
