 ...
 */
public class SwitchTargetByAttackerIndicatorAction extends Action {
	...
	public SwitchTargetByAttackerIndicatorAction(AttackerIndicator target, int percentToAdd, int pointsToAdd, boolean restrictedRange) {
		super(ActionType.switch_target_by_attacker_indicator);
		this.target = target;
	...
	public void performAction(MechanicEvent event, AbstractMechanicsAI2 ai) {
		Creature targ = getAttackerIndicator(target, ai);
	...
	public boolean equals(Object obj) {
		if (obj instanceof SwitchTargetByAttackerIndicatorAction) {
			SwitchTargetByAttackerIndicatorAction o = (SwitchTargetByAttackerIndicatorAction) obj;
