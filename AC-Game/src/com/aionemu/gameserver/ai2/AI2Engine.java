...
import com.aionemu.gameserver.ai2.ai.registration.DefaultAIRegistrationHandler;
...
/**
 * @author ATracer
 * @modified Yon (Aion Reconstruction Project) -- Added support for {@link DefaultAIRegistrationHandler}.
 */
public class AI2Engine implements GameEngine {
	...
	public void load(CountDownLatch progressLatch) {
		...
		DefaultAIRegistrationHandler.registerAIs();
