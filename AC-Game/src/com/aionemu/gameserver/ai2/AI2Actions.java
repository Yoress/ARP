 ...
 *
 * @author ATracer
 * @modified Yon (Aion Reconstruction Project) -- added {@link #useSkill(AbstractAI, int, int)}.
 */
public class AI2Actions {
	...
	/**
	 * Use skill with the specified ID and Skill Level.
	 */
	public static void useSkill(AbstractAI ai2, int skillId, int skillLevel) {
		ai2.getOwner().getController().useSkill(skillId, skillLevel);
	}
