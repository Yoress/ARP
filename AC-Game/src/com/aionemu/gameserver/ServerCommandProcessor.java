	...
	public void run() {
		...
		try {
			while ((command = br.readLine()) != null) {
				//this will run finalizers and shutdown hooks for a clean shutdown.
				if (command.equalsIgnoreCase("shutdown") || command.equalsIgnoreCase("quit") || command.equalsIgnoreCase("exit")) System.exit(0);
			}
		} catch (IOException e) {
