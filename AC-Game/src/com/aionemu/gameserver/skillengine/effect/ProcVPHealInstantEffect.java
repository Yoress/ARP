	...
	public void applyEffect(Effect effect) {
		if (effect.getEffected() instanceof Player) {
			...
			if (pcd.getCurrentReposteEnergy() < cap) {
				...
				PacketSendUtility.sendPacket(player, new SM_STATUPDATE_EXP(pcd.getExpShown(), pcd.getExpRecoverable(), pcd.getExpNeed(), pcd.getCurrentReposteEnergy(), pcd.getMaxReposteEnergy(), pcd.getCurrentEventExp()));
			}
		}
	}
}
