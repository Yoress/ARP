...
/**
 * Created by Kill3r
 * @modified Yon (Aion Reconstruction Project) -- added {@link #calculate(Effect)} override because this shit was stunning bosses.
 */
...
public class StunAlwaysEffect extends EffectTemplate {
	...
	public void calculate(Effect effect) {
		effect.setIsForcedEffect(true); //TODO: Probably shouldn't be forced because the skill might be avoidable (evasion/resist)
		calculate(effect, StatEnum.STUN_RESISTANCE, null);
	}
	...
	public void startEffect(Effect effect) {
		...
		effect.getEffected().getEffectController().setAbnormal(AbnormalState.STUN.getId(), effect.getEffector());
