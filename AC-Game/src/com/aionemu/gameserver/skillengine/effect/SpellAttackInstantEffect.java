...
public class SpellAttackInstantEffect extends DamageEffect {
	...
	public void calculate(Effect effect) {
		...
		/*
		 * if (effect.getSkillId() == 2713) { if (effected instanceof Npc) { effect.getEffected().getEffectController().setAbnormal(AbnormalState.
		 * STUN.getId()); } else if (effected instanceof Player) { return; } }
		 */
