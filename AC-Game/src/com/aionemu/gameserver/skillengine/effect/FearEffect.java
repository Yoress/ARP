...
public class FearEffect extends EffectTemplate {
	...
	public void startEffect(final Effect effect) {
		...
		effected.getEffectController().setAbnormal(AbnormalState.FEAR.getId(), effect.getEffector());
		...
		// resistchance of fear effect to damage, if value is lower than 100, fear can be interrupted by damage
	...
	public void endEffect(Effect effect) {
		...
		if (GeoDataConfig.FEAR_ENABLE) {
			effect.getEffected().getMoveController().abortMove();// TODO implstopMoving?
		}
