 ...
 * @modified Yon (Aion Reconstruction Project) -- CM_SERVER_CHECK set to require AUTHED state, instead of CONNECTED state,
 * added {@link CM_QUESTION_ACCEPT_SUMMON_RESPONSE}, and {@link CM_FRIEND_SET_MEMO}.
 */
public class AionPacketHandlerFactory {
	...
	public AionPacketHandlerFactory() {
		...
		addPacket(new CM_TUNE_PREVIEW_RESPONSE(0x1B0, State.IN_GAME));//
		...
		addPacket(new CM_SERVER_CHECK(0x199, State.AUTHED, State.IN_GAME));//
		...
		addPacket(new CM_QUESTION_ACCEPT_SUMMON_RESPONSE(0x165, State.IN_GAME));//
		...
		// addPacket(new CM_GM_COMMAND_ACTION(0x195, State.IN_GAME)); Check
		// Later
		// addPacket(new CM_ADMIN_PANEL(0x14A, State.IN_GAME));
		
		/////////////////////// REMOVED PACKETS\\\\\\\\\\\\\\\\\\\\\\\\\
		// addPacket(new CM_PETITION(0xF6, State.IN_GAME)); Packet removed since
		/////////////////////// 4.3
		// addPacket(new CM_IN_GAME_SHOP_INFO(0x184, State.IN_GAME)); removed
		/////////////////////// since 4.7
	}
