...
public class EncryptionKeyPair {
	 ...
	 */
	private final static byte staticClientPacketCode = 0x65; // 4.3 | 4.5 | 4.6
															 // | 4.7
	/**
	...
	public EncryptionKeyPair(int baseKey) {
		...
		this.keys[SERVER] = new byte[] {(byte) (baseKey & 0xff), (byte) ((baseKey >> 8) & 0xff), (byte) ((baseKey >> 16) & 0xff), (byte) ((baseKey >> 24) & 0xff), (byte) 0xa1, (byte) 0x6c,
										(byte) 0x54, (byte) 0x87};
