...
public class CM_DIALOG_SELECT extends AionClientPacket {
	...
	protected void runImpl() {
		...
		if (targetObjectId == 0 || targetObjectId == player.getObjectId()) {
			...
			// FIXME client sends unk1=1, targetObjectId=0, dialogId=2 (trader)
			// => we miss some packet to close window
		...
		// log.info("id: "+targetObjectId+" dialogId: " + dialogId +" unk1: " +
		// unk1 + " questId: "+questId);
	}
}
