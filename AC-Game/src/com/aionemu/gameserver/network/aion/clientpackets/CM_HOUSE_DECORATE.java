...
public class CM_HOUSE_DECORATE extends AionClientPacket {
	...
	int objectId;
	int templateId;
	int lineNr; // Line number (starts from 1 in 3.0 and from 2 in 3.5) of part
				 // in House render/update packet
	...
	protected void runImpl() {
		...
		if (objectId == 0) {
			...
			house.getRegistry().setPartInUse(decor, floor);
			sendPacket(new SM_HOUSE_EDIT(4, 2, objectId)); // yes, in retail
															 // it's sent twice!
		}
