...
public class AionConnection extends AConnection {
	...
	// TODO! why there is no any comments what is this doing? i have no clue
	// what is it for [Nemesiss]
	 ...
	 * Dispatcher Thread], and onDisconnect() method will be called to clear all other things. forced means that server shouldn't wait with removing
	 * this connection.
	 *
	...
	public String toString() {
		...
		if (player != null) {
			return "AionConnection [state=" + state + ", account=" + account + ", getObjectId()=" + player.getObjectId() + ", lastPlayerName=" + lastPlayerName + ", macAddress=" + macAddress
					+ ", getIP()=" + getIP() + "]";
		}
		return "";
	}
