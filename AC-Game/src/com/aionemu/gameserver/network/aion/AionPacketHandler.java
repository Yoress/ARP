 ...
 * @author Luno
 * @author GiGatR00n
 * @modified Yon (Aion Reconstruction Project) -- {@link #getClientPacketName(int)}
 * changed to public and reworked for simplicity.
 */
public final class AionPacketHandler {
	...
	public final void addPacketPrototype(AionClientPacket packetPrototype) {
	...
	private AionClientPacket getPacket(State state, int id, ByteBuffer buf, AionConnection con) {
		...
		//TODO: Investigate why this was left behind
...
//		}
	...
	public String getClientPacketName(int id) {
		AionClientPacket packet = packetsPrototypes.get(id);
		if (packet instanceof AionClientPacket) {
			return packet.getClass().getSimpleName();
		}
		//Who fucking wrote this shit? Was it GiGatR00n?
//		switch (id) {
//		case 344:
