...
public final class SM_SYSTEM_MESSAGE extends AionServerPacket {
	...
	/**
	 * [%Protector] received the %num0 damage inflicted on [%SkillTarget] by [%SkillCaster]'s [%SkillName], because of the protection effect cast on
	 * it.
	 */
	...
	/**
	 * The Support service cannot be used in the hours between %0 and %1 o' clock. Please use the Return skill if you are locked in an impassable
	 * area.
	 */
	 ...
	 * /ChangeChannelLeader [ChannelNumber] [CharacterName]: The channel owner makes another character the channel owner. /ChangeChannelPassword
	 * [ChannelNumber] [Password]: The channel owner can change the password. /ChannelHelp: Shows the commands available for channels.
	 */
	...
	/**
	 * Your petition has been received.\nThe receipt number is %0.\nThere are %1 users on the waiting list, and the approximate waiting time is
	...
	/**
	 * %WORLDNAME0% region restricts access. You cannot reenter the region for %1 minute(s) if all your group members left the region or if you left
	 * the current group.
	 */
	...
	/**
	 * The playing time will expire in %*0. If you wish to continue using the service, please make additional payments on the Billing Page of the
	 * Plaync website.
	 */
	...
	/**
	 * You entered into the Phase %num0 Restriction state because the auto hunting reports have accumulated. You can check the Restriction Phase and
	...
	/**
	 * You are currently in Phase 2 Restriction State, and will be downgraded to Phase 1 in %0 minutes. You now receive less XP, Kinah and Abyss
	 * Points, and the chance of successful gathering and extraction has been decreased. You will face greater restrictions if reports continue to
	 * accumulate.
	 */
	...
	/**
	 * You are currently in Phase 3 Restriction State and will be downgraded to Phase 2 in %0 minutes. You cannot acquire any loot, and you now
	 * receive less XP, Kinah and Abyss Points, and the chance of successful gathering and extraction has been significantly decreased. You are banned
	 * from joining a Group or Alliance. You will face greater restrictions if reports continue to accumulate.
	 */
	...
	/**
	 * You are currently at Phase 4 Restriction State and will be downgraded to Phase 3 in %0 minutes. You cannot acquire any loot, XP, Kinah, or
	 * Abyss Points, and are unable to gather or extract any items. You are also banned from joining a Group or Alliance.
	 */
	...
	/**
	 * Because you belong to an Alliance, you cannot post a <Recruit Mentor Group> message. Use /RecruitAllianceMember and the <Recruit Alliance>
	 * window instead.
	 */
	...
	public static final SM_SYSTEM_MESSAGE STR_MSG_ITEM_REIDENTIFY_CANNOT_REIDENTIFY(final int nameId) {
		return new SM_SYSTEM_MESSAGE(1401636, new DescriptionId(nameId));
	}
	...
	public static SM_SYSTEM_MESSAGE STR_MSG_ITEM_AUTHORIZE_SUCCEEDED(int nameId, int level) {
		return new SM_SYSTEM_MESSAGE(1402148, new DescriptionId(nameId), Integer.valueOf(level));
	}
