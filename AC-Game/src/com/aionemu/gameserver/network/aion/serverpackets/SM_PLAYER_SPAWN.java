 ...
 *
 * @author -Nemesiss-
 * @modified Yon (Aion Reconstruction Project) -- Added a check for FTS config
 */
public class SM_PLAYER_SPAWN extends AionServerPacket {
	...
	protected void writeImpl(AionConnection con) {
		...
		if (FastTrackConfig.FASTTRACK_ENABLE && World.getInstance().getWorldMap(player.getWorldId()).getTemplate().getBeginnerTwinCount() > 0) {
