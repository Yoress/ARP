 ...
 * @modified Yon (Aion Reconstruction Project) -- Changed how the HP percentages were calculated.
 */
...
//		writeC((int) (100f * attackerCurrHp / attackerMaxHp)); // attacker %hp
		//Use convenience method, old handling can return zero before the entity is dead.
