	...
	protected void writeImpl(AionConnection con) {
		...
		case 301310000: // Idgel Dome
			...
			case 3:
				...
				break;
			case 4:// Dead=60 - Spawn=0 (For Each <PLAYER> Died/Spawned)
					// OnDie()|OnRevive()
				writeD(15);
				writeD(PlayerStatus);// Spawn(0) - Dead(60)
				writeD(object); // PlayerObjectId
			...
			case 5: // Reward OnBossKilled()|OnTimeOut() (End-Instance Packet)
				...
				writeD(idpr.getRewardCount());
				writeD(idpr.getAdditionalReward());// ...Additional Reward Box
													// #1
			...
			case 6: // Preparing Time & Starting Score/PvPKill (BothTeam)
				...
				writeD((idr.getInstanceScoreType() == InstanceScoreType.PREPARING ? 65535 : 1));
				break;
			case 7: // Instance Players Info (PlayersName, ClassId, AbyssRank,
					 // PvPKills, Score, ...) (Who still in Instance)
			...
			case 10:
				...
				writeD(object);
				break;
			case 11: // Send when a NPC/Player has been dead (Send 2-times with
					 // different RaceId)
