 ...
 * @modified Yon (Aion Reconstruction Project) -- Added windstream strafe support.
 */
public class SM_EMOTION extends AionServerPacket {
	...
	protected void writeImpl(AionConnection con) {
		...
		case WINDSTREAM_STRAFE:
			writeC(emotion); //0x1 (strafe left) or 0x2 (strafe right)
			break;
		case DIE: // die
		...
		case RIDE:
			...
			writeC(0x40);// unk
			break;
		case RIDE_END: //TODO: Something here is causing the client to say "This item cannot be used while moving."
			if (targetObjectId != 0) {
				writeD(targetObjectId);// rideId
			}
			writeH(0);// emotion?
