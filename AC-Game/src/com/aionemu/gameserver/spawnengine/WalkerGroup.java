...
public class WalkerGroup {
	...
	private List<ClusteredNpc> members; //FIXME: Remove NPC when it is removed from map? Potential memory leak
	 ...
	 * @param shift - distance from origin located in lines perpendicular to destination; for SagittalShift if negative then located to the left from
