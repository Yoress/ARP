...
public class PricesService {
	...
	public static final long getKinahForBuy(long requiredKinah, Race playerRace) {
		...
		return (long) ((long) ((long) ((long) (requiredKinah * getVendorBuyModifier() / 100.0D) * getGlobalPrices(playerRace) / 100.0D) * getGlobalPricesModifier() / 100.0D) * getTaxes(playerRace)
				/ 100.0D);
	}
