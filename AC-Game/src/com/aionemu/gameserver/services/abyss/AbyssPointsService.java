 ...
 * @modified Yon (Aion Reconstruction Project) -- {@link #checkRankChanged(Player, AbyssRankEnum, AbyssRankEnum)} and
 * {@link #checkRankGpChanged(Player, AbyssRankEnum, AbyssRankEnum)} now send the packet to the player to update their
 * profile info (instead of the calling method).
 */
...
//		PacketSendUtility.sendPacket(player, new SM_ABYSS_RANK(player.getAbyssRank()));
	...
	public abstract static class AddAPGlobalCallback implements Callback {
		...
		public CallbackResult afterCall(Object obj, Object[] args, Object methodResult) {
			...
			// Only Players or SiegeNpc(from SiegeModType.SIEGE or .ASSAULT) can
			// add points
