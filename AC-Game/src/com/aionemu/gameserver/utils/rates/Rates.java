 ...
 * @modified Yon (Aion Reconstruction Project) -- Created static Rates objects for the various Rates so a new Rates object is not
 * instantiated for every Player -- Rates are essentially static, so there's no need for multiple copies of these objects.
 */
public abstract class Rates {
	
	public final static Rates REGULAR_RATES = new RegularRates();
	
	public final static Rates PREMIUM_RATES = new PremiumRates();
	
	public final static Rates VIP_RATES = new VipRates();
