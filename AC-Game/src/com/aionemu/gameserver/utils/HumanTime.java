...
/**
 * HumanTime parses and formats time deltas for easier reading by humans. It can format time information without losing information but its main
 * purpose is to generate more easily understood approximations.
 ...
 * ({@link HumanTime#HumanTime()}) and set the delta using the {@link #y()}, {@link #d()}, {@link #h()}, {@link #s()} and {@link #ms()} methods or
 * parse a {@link CharSequence} representation ({@link #eval(CharSequence)}). Parsing ignores whitespace and is case insensitive.
 * </p>
 * <h3>HumanTime format</h3>
 * <p>
 * HumanTime will format time deltas in years ("y"), days ("d"), hours ("h"), minutes ("m"), seconds ("s") and milliseconds ("ms"), separated by a
 * blank character. For approximate representations, the time delta will be round up or down if necessary.
 * </p>
 ...
 * @see <a href= "http://johannburkard.de/blog/programming/java/date-formatting-parsing-humans-humantime.html">Date Formatting and Parsing for Humans
 * in Java with HumanTime</a>
 */
