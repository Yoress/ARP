...
public abstract class BoundingVolume implements Collidable {
	...
	/**
	 * <code>whichSide</code> returns the side on which the bounding volume lies on a plane. Possible values are POSITIVE_SIDE, NEGATIVE_SIDE, and
	 * NO_SIDE.
	 *
	...
	/**
	 * <code>merge</code> combines two bounding volumes into a single bounding volume that contains both this bounding volume and the parameter
	 * volume.
	 *
	...
	/**
	 * <code>mergeLocal</code> combines two bounding volumes into a single bounding volume that contains both this bounding volume and the parameter
	...
	/**
	 * determines if this bounding volume and a second given volume are intersecting. Intersecting being: one volume contains another, one volume
