...
public class Box extends AbstractBox {
	 ...
	 * Creates a new box.
	 * <p/>
	 * The box has a center of 0,0,0 and extends in the out from the center by the given amount in <em>each</em> direction. So, for example, a box
	 ...
	 * Creates a new box.
	 * <p/>
	 * The box has the given center and extends in the out from the center by the given amount in <em>each</em> direction. So, for example, a box with
	 ...
	 * <p/>
	 * The minimum and maximum point are provided, these two points define the shape and size of the box but not it's orientation or position. You
	 * should use the {@link com.jme3.scene.Spatial#setLocalTranslation(com.jme3.math.Vector3f) } and
