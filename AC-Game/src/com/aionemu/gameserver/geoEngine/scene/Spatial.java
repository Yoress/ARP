 ...
 * @modified Yon (Aion Reconstruction Project) -- {@link #getMaterialId()} modified to return an int.
 */
public abstract class Spatial implements Collidable, Cloneable {
	...
	/**
	 * Called by {@link Node#attachChild(Spatial)} and {@link Node#detachChild(Spatial)} - don't call directly. <code>setParent</code> sets the parent
	 * of this node.
	 *
