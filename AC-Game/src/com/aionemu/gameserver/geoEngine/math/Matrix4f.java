...
/**
 * <code>Matrix4f</code> defines and maintains a 4x4 matrix in row major order. This matrix is intended for use in a translation and rotational
 * capacity. It provides convenience methods for creating the matrix from a multitude of sources.
 * <p/>
 * Matrices are stored assuming column vectors on the right, with the translation in the rightmost column. Element numbering is row,column, so m03 is
 * the zeroth row, third column, which is the "x" translation part. This means that the implicit storage order is column major. However, the get() and
...
public final class Matrix4f implements Cloneable {
	...
	/**
	 * Constructor instantiates a new <code>Matrix</code> that is set to the provided matrix. This constructor copies a given Matrix. If the provided
	...
	/**
	 * <code>mult</code> multiplies this matrix with another matrix. The result matrix will then be returned. This matrix will be on the left hand
	...
	/**
	 * <code>mult</code> multiplies this matrix with another matrix. The results are stored internally and a handle to this matrix will then be
	 * returned. This matrix will be on the left hand side, while the parameter matrix will be on the right.
	 *
	 * @param in2 the matrix to multiply this matrix by.
	 * @return the resultant matrix
	 */
	...
	/**
	 * <code>mult</code> multiplies a vector about a rotation matrix and adds translation. The w value is returned as a result of multiplying the last
	...
	/**
	 * <code>angleRotation</code> sets this matrix to that of a rotation about three axes (x, y, z). Where each axis has a specified rotation in
	 * degrees. These rotations are expressed in a single <code>Vector3f</code> object.
	 *
	...
	/**
	 * <code>toString</code> returns the string representation of this object. It is in a format of a 4x4 matrix. For example, an identity matrix
