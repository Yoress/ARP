...
/**
 * <code>Plane</code> defines a plane where Normal dot (x,y,z) = Constant. This provides methods for calculating a "distance" of a point from this
 * plane. The distance is pseudo due to the fact that it can be negative if the point is on the non-normal side of the plane.
 *
 * @author Mark Powell
 * @author Joshua Slack
 */
public class Plane implements Cloneable {
	...
	/**
	 * <code>pseudoDistance</code> calculates the distance from this plane to a provided point. If the point is on the negative side of the plane the
	...
	/**
	 * <code>whichSide</code> returns the side at which a point lies on the plane. The positive values returned are: NEGATIVE_SIDE, POSITIVE_SIDE and
	 * NO_SIDE.
	 *
	 * @param point the point to check.
	...
	/**
	 * <code>toString</code> returns a string thta represents the string representation of this plane. It represents the normal as a
	 * <code>Vector3f</code> object, so the format is the following: com.jme.math.Plane [Normal: org.jme.math.Vector3f [X=XX.XXXX, Y=YY.YYYY,
