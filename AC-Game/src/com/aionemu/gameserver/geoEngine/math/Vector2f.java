...
public final class Vector2f implements Cloneable {
	...
	/**
	 * <code>add</code> adds a provided vector to this vector creating a resultant vector which is returned. If the provided vector is null, null is
	 * returned.
	 *
	...
	/**
	 * <code>addLocal</code> adds a provided vector to this vector internally, and returns a handle to this vector for easy chaining of calls. If the
	...
	/**
	 * Multiplies this Vector2f's x and y by the scalar and stores the result in product. The result is returned for chaining. Similar to
	 * product=this*scalar;
	 *
	...
	/**
	 * <code>divideLocal</code> divides this vector by a scalar internally, and returns a handle to this vector for easy chaining of calls. Dividing
	...
	/**
	 * <code>subtract</code> subtracts the values of a given vector from those of this vector creating a new vector object. If the provided vector is
	...
	/**
	 * <code>subtract</code> subtracts the values of a given vector from those of this vector storing the result in the given vector object. If the
	...
	/**
	 * <code>subtractLocal</code> subtracts a provided vector to this vector internally, and returns a handle to this vector for easy chaining of
	...
	/**
	 * <code>subtractLocal</code> subtracts the provided values from this vector internally, and returns a handle to this vector for easy chaining of
	 * calls.
	 *
	 * @param valX value to subtract from x
	 * @param valY value to subtract from y
	...
	/**
	 * <code>smallestAngleBetween</code> returns (in radians) the minimum angle between two vectors. It is assumed that both this vector and the given
	...
	/**
	 * <code>angleBetween</code> returns (in radians) the angle required to rotate a ray represented by this vector to lie colinear to a ray described
	 * by the given vector. It is assumed that both this vector and the given vector are unit vectors (iow, normalized).
	 *
	...
	/**
	 * <code>getAngle</code> returns (in radians) the angle represented by this Vector2f as expressed by a conversion from rectangular coordinates (
	...
	/**
	 * <code>hashCode</code> returns a unique code for this vector object based on it's values. If two vectors are logically equivalent, they will
	...
	/**
	 * <code>toString</code> returns the string representation of this vector object. The format of the string is such: com.jme.math.Vector2f
	 * [X=XX.XXXX, Y=YY.YYYY]
	 *
