...
public class Eigen3f {
	...
	/**
	 * Check the rank of the given Matrix to determine if it is positive. While doing so, store the max magnitude entry in the given float store and
	 * the max row of the matrix in the Vector store.
	 *
