...
/**
 * <code>Triangle</code> defines a object for containing triangle information. The triangle is defined by a collection of three <code>Vector3f</code>
 * objects.
 *
 * @author Mark Powell
 * @author Joshua Slack
...
public class Triangle extends AbstractTriangle implements Reusable {
	...
	/**
	 * Constructor instantiates a new <Code>Triangle</code> object with the supplied vectors as the points. It is recommended that the vertices be
	 * supplied in a counter clockwise winding to support normals for a right handed coordinate system.
	 *
