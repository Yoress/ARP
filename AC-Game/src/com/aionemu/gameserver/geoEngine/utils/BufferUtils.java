...
public final class BufferUtils {
	...
	/**
	 * Generate a new FloatBuffer using the given array of Vector3f objects. The FloatBuffer will be 3 * data.length long and contain the vector data
	...
	/**
	 * Create a new FloatBuffer of an appropriate size to hold the specified number of Vector3f object data only if the given buffer if not already
	 * the right size.
	 *
	 ...
	 */
	/*
	 * public static void setInBuffer(ColorRGBA color, FloatBuffer buf, int index) { buf.position(index*4); buf.put(color.r); buf.put(color.g);
	...
	/**
	 * Copies a Vector3f from one position in the buffer to another. The index values are in terms of vector number (eg, vector number 0 is postions
	...
	/**
	 * Generate a new FloatBuffer using the given array of Vector2f objects. The FloatBuffer will be 2 * data.length long and contain the vector data
	...
	/**
	 * Create a new FloatBuffer of an appropriate size to hold the specified number of Vector2f object data only if the given buffer if not already
	 * the right size.
	 *
	 * @param buf the buffer to first check and rewind
	 * @param vertices number of vertices that need to be held by the newly created buffer
	...
	/**
	 * Generate a new IntBuffer using the given array of ints. The IntBuffer will be data.length long and contain the int data as data[0], data[1]...
	 * etc.
	 *
	...
	/**
	 * Create a new DoubleBuffer of an appropriate size to hold the specified number of doubles only if the given buffer if not already the right
	 * size.
	 *
	 * @param buf the buffer to first check and rewind
	...
	/**
	 * Creates a new DoubleBuffer with the same contents as the given DoubleBuffer. The new DoubleBuffer is seperate from the old one and changes are
	 * not reflected across. If you want to reflect changes, consider using Buffer.duplicate().
	 *
	...
	/**
	 * Creates a new FloatBuffer with the same contents as the given FloatBuffer. The new FloatBuffer is seperate from the old one and changes are not
	 * reflected across. If you want to reflect changes, consider using Buffer.duplicate().
	 *
	...
	/**
	 * Creates a new IntBuffer with the same contents as the given IntBuffer. The new IntBuffer is seperate from the old one and changes are not
	 * reflected across. If you want to reflect changes, consider using Buffer.duplicate().
	 *
	...
	/**
	 * Creates a new ByteBuffer with the same contents as the given ByteBuffer. The new ByteBuffer is seperate from the old one and changes are not
	 * reflected across. If you want to reflect changes, consider using Buffer.duplicate().
	 *
	...
	/**
	 * Creates a new ShortBuffer with the same contents as the given ShortBuffer. The new ShortBuffer is seperate from the old one and changes are not
	 * reflected across. If you want to reflect changes, consider using Buffer.duplicate().
	 *
	...
	/**
	 * Ensures there is at least the <code>required</code> number of entries left after the current position of the buffer. If the buffer is too small
