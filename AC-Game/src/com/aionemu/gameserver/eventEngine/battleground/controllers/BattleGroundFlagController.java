	...
	public void onDialogRequest(final Player player) {
		...
		if (player.getBattleGround() != null && player.getBattleGround().running) {
			if (dropped && player.getController().getTask(TaskId.BATTLEGROUND_CARRY_FLAG) == null && player.getCommonData().getRace() != getOwner().getRace() && getOwner().getFlagHolder() == null) {
				...
				player.getBattleGround().broadcastToBattleGround(player.getCommonData().getName() + (player.getLegion() != null ? " of " + player.getLegion().getLegionName() : "") + " got the "
						+ (getOwner().getRace() == Race.ELYOS ? "Elyos" : "Asmodian") + " flag !", null);
				...
				player.getBattleGround().broadcastToBattleGround(player.getCommonData().getName() + (player.getLegion() != null ? " of " + player.getLegion().getLegionName() : "")
						+ " has dropped the " + (player.battlegroundFlag.getRace() == Race.ELYOS ? "Elyos" : "Asmodian") + " flag !", null);
				...
				player.getBattleGround().broadcastToBattleGround(player.getCommonData().getName() + (player.getLegion() != null ? " of " + player.getLegion().getLegionName() : "")
						+ " has returned the " + (getOwner().getRace() == Race.ELYOS ? "Elyos" : "Asmodian") + " flag at its base !", null);
