...
public class CTFBattleGround extends BattleGround {
	...
	public void start() {
		 ...
		 * Spawn Healers
		 */
		SpawnTemplate se = SpawnEngine.addNewSingleTimeSpawn(bgTemplate.getWorldId(), 203098, bgTemplate.getHealerLocation().getXe(), bgTemplate.getHealerLocation().getYe(),
				bgTemplate.getHealerLocation().getZe(), (byte) 0);
		SpawnTemplate sa = SpawnEngine.addNewSingleTimeSpawn(bgTemplate.getWorldId(), 203557, bgTemplate.getHealerLocation().getXa(), bgTemplate.getHealerLocation().getYa(),
				bgTemplate.getHealerLocation().getZa(), (byte) 0);
		
		/*
		 * Spawn Flags
		 */
		SpawnTemplate sfe = SpawnEngine.addNewSingleTimeSpawn(bgTemplate.getWorldId(), 700336, bgTemplate.getFlagLocation().getXe(), bgTemplate.getFlagLocation().getYe(),
				bgTemplate.getFlagLocation().getZe(), (byte) 0);
		SpawnTemplate sfa = SpawnEngine.addNewSingleTimeSpawn(bgTemplate.getWorldId(), 700037, bgTemplate.getFlagLocation().getXa(), bgTemplate.getFlagLocation().getYa(),
				bgTemplate.getFlagLocation().getZa(), (byte) 0);
