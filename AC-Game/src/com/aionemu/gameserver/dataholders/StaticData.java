 ...
 * @modified Yon (Aion Reconstruction Project) -- Added {@link #questConnectionData}.
 */
...
public class StaticData {
	...
	@XmlElement(name = "connected_quests")
	public QuestConnectionsData questConnectionData;
	...
	private void afterUnmarshal(Unmarshaller unmarshaller, Object parent) {
		...
		DataManager.log.info("Loaded " + questConnectionData.size() + " connected quest data entries");
