...
public class TribeRelationsData {
	...
	public boolean isAggressiveRelation(TribeClass tribeName1, TribeClass tribeName2) {
		...
		return (tribe1.getAggro().contains(tribe2.getBase()) || tribe1.getAggro().contains(tribeName2) || tribe2.getAggro().contains(tribe1.getBase()) || tribe2.getAggro().contains(tribeName1))
				&& (!tribe1.getNeutral().contains(tribeName2) && !tribe2.getNeutral().contains(tribeName1));
	}
