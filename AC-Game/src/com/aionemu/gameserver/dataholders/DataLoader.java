 ...
 * <br>
 * <font color="red">NOTICE: </font> This class is used temporarily and later will be removed and npc and spawn data will be loaded with xml
 * loader.<br>
 * <br>
...
abstract class DataLoader {
	 ...
	 * <li>Given file is a <b>directory</b>, then this method is obtaining list of all visible .txt files in this directory and subdirectiores (
	 * except hidden ones and those named "new" ) and call {@link #loadFile(File)} for each of these files.
	 * </ul>
	 */
	...
	protected void loadData() {
		if (dataFile.isDirectory()) {
			Collection<?> files = FileUtils.listFiles(dataFile,
					FileFilterUtils.andFileFilter(FileFilterUtils.andFileFilter(FileFilterUtils.notFileFilter(FileFilterUtils.nameFileFilter("new")), FileFilterUtils.suffixFileFilter(".txt")),
	...
	/**
	 * This method must be overriden in every subclass and is responsible for parsing given <tt>dataEntry</tt> String which represents one row from
	 * data file.
	 *
	...
	/**
	 * This method must be overriden in subclass which we want to be able to save data. It's responsibility is basicly to put data into given
	 * FileWriter instance.
	 *
	 * @param fileWriter
	 * @throws Exception
