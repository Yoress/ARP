...
/**
 * @author lord_rex
 * @modified Yon (Aion Reconstruction Project) -- Changed {@link #shutdownHook(int, int, ShutdownMode)} to not
 * allow an interval of 0. Added config check to stats dump.
 */
public class ShutdownHook extends Thread {
	...
	private void shutdownHook(int duration, int interval, ShutdownMode mode) {
		...
		if (CommonsConfig.RUNNABLESTATS_ENABLE) RunnableStatsManager.dumpClassStats(SortBy.AVG);
