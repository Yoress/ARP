...
/**
 * @author MrPoke
 * @modified Yon (Aion Reconstruction Project) -- Testing insideness should also include points on the border.
 */
public class SphereArea implements Area {
	...
	public boolean isInside3D(Point3D point) {
		return MathUtil.isIn3dRange(x, y, z, point.getX(), point.getY(), point.getZ(), r + Float.MIN_NORMAL);
	}
	
	@Override
	public boolean isInside3D(float x, float y, float z) {
		return MathUtil.isIn3dRange(x, y, z, this.x, this.y, this.z, r + Float.MIN_NORMAL);
	}
