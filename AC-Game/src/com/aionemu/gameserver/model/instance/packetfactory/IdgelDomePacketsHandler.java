...
public class IdgelDomePacketsHandler {
	...
	public void startInstanceTask() {
		...
		idgelTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				...
				sendScoreTypePacket();// Send 1-Time when Start_Progress and
										// End_Progress
			}
		...
		idgelTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				sendInstanceInfoPacket();
				sendMsgByRace(1402367, Race.PC_ALL, 0);// Destroyer Kunax has
														// appeared in the
														// Slaying Arena.
				sp(234190, 264.4382f, 258.58527f, 85.81963f, (byte) 30, 0);// .....Destroyer
																			// Kunax.
				sp(234751, 273.76373f, 258.95422f, 85.81963f, (byte) 15, 0);// ....Sheban
																			// Elite
																			// Stalwart.
				sp(234751, 250.63719f, 244.0336f, 92.942505f, (byte) 75, 0);// ....Sheban
																			// Elite
																			// Stalwart.
				sp(234753, 256.33893f, 259.0221f, 85.81963f, (byte) 75, 0);// .....Sheban
																			// Elite
																			// Marauder.
				sp(234753, 278.2619f, 273.78964f, 92.942535f, (byte) 15, 0);// ....Sheban
																			// Elite
																			// Marauder.
				sp(234752, 264.9393f, 267.92413f, 85.81963f, (byte) 45, 0);// .....Sheban
																			// Elite
																			// Sniper.
				sp(234754, 264.97153f, 249.82945f, 85.81963f, (byte) 105, 0);// ...Sheban
																				// Elite
																				// Medic.
			}
		}, 600000 + idr.getPreparingTime()));
	...
	protected void SpawnFlameVents() {
		sp(802192, 199.18739f, 191.76154f, 80.602165f, (byte) 15, 0);// ...Flame
																		// Vent
																		// Elyos
