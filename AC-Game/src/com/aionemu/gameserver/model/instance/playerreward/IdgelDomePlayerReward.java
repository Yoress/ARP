...
public class IdgelDomePlayerReward extends InstancePlayerReward {
	...
	/**
	 * BUFF_SHIELD applies when your score in Idgel Dome is lower than the enemy's. Increases PvP Physical Attack, PvP Magic Attack, PvP Physical
	 * Defense, and PvP Magical Defense by 30%
	 */
