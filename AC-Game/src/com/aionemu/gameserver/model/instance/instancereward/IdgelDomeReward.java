...
public class IdgelDomeReward extends InstanceReward<IdgelDomePlayerReward> {
	 ...
	 * 
	 * 5156(Win+BossKilled) : 3163(Win) 3024(Loss+BossKilled) : 1031(Loss)
	 */
	 ...
	 * 
	 * 200(Win+BossKilled) : 150(Win) 125(Loss+BossKilled) : 75(Loss)
	 */
	...
	public void portToPosition(Player player) {
		...
		Point3D ElyosStartPoint = new Point3D(270.1437f + Rx, 348.6699f + Ry, 79.44365f);// Elyos
																							// Center
		Point3D AsmoStartPoint = new Point3D(258.5553f + Rx, 169.85149f + Ry, 79.430855f);// Asmo
																							// Center
	...
	public int getRemainingTime() {
		...
		if (result < PreparingTime) {
			return (int) (PreparingTime - result);// ...Count Down Before
													// Starting Instance.
													// 60,59,58,57,...,0
		} else if (result < getEndTime()) {// ..........20 Minutes +
											// PreparingTime(1.30 Min)
