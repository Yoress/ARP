...
/**
 * @author Cheatkiller
 * @modified Yon (Aion Reconstruction Project) -- Added the base Magic Attack of the owner to the Summon.
 */
public class HomingGameStats extends SummonedObjectGameStats {
	...
	public Stat2 getStat(StatEnum statEnum, int base) {
		...
		switch (statEnum) {
			case MAGICAL_ATTACK:
				...
				stat.addToBase(owner.getMaster().getGameStats().getMainHandMAttack().getBase());
	...
	public Stat2 getMainHandMAttack() {
		...
		//TODO: Use these stats or move them to data; currently the names have uppercase letters and all the checks will fail.
		switch (skillLvl) {
			case 3:
