...
/**
 * @author ATracer
 * @modified Yon (Aion Reconstruction Project) -- {@link #getHpPercentage()} tweaked slightly.
 */
public abstract class CreatureLifeStats<T extends Creature> {
	...
	/**
	 * The purpose of this method is synchronize current HP and MP with updated MAXHP and MAXMP stats This method should be called only on creature
	 * load to game or player level up
	 */
...
//		}
		int ret = (int) (100f * currentHp / getMaxHp());
		if (ret == 0 & currentHp > 0) return 1;
		return ret;
	}
