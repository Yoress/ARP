...
/**
 * @author ATracer
 * @modified Yon (Aion Reconstruction Project) -- added a call to super within {@link #onStatsChange(boolean)}.
 */
public class SummonGameStats extends CreatureGameStats<Summon> {
	...
	public Stat2 getMovementSpeed() {
		...
		if (master != null && (master.isFlying() || master.isInState(CreatureState.GLIDING))) {
			bonusSpeed += 3000;
		}
