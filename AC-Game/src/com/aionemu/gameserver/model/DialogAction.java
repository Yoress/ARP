...
/**
 * @author Rolandas
 * @modified Yon (Aion Reconstruction Project) -- changed {@link #getActionByDialogId(int)} to return {@link #NULL} instead of null if
 * an action matching the passed in ID cannot be found.
 */
public enum DialogAction {
	...
	public static DialogAction getActionByDialogId(int id) {
		...
		LoggerFactory.getLogger(DialogAction.class).error("Missing DialogAction ID: " + id + ", returning NULL DialogAction.");
		return NULL;
	}
}
