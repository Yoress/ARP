...
public class MaintenanceTask extends AbstractCronTask {
	...
	protected void executeTask() {
		...
		for (House house : maintainedHouses) {
			...
			//FIXME: I believe the player should be refunded the initial purchase price of the house (what they paid at auction) if it's seized.
			//Might have to get kinah amount from #putHouseToAuction().
