...
/**
 * @author Rolandas
 * @modified Yon (Aion Reconstruction Project) -- added {@link #getInitialBidPrice()}, {@link #setInitialBidPrice(long)},
 * and {@link #initialBidPrice}; maintained contract of {@link #Clone()}.
 */
public class HouseBidEntry implements Cloneable {
	...
	private final long unk2 = 100000; //Minimum bid amount?
	...
	public long getInitialBidPrice() {
	...
	public long getRefundKinah() {
		return (long) (initialBidPrice * 0.3F);
	}
	...
	public Object Clone() {
		...
		cloned.initialBidPrice = this.initialBidPrice;
