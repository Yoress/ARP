...
public class NpcFactions {
	...
	private void askLeaveNpcFaction(final Npc npc) {
		...
		if (requested) {
			PacketSendUtility.sendPacket(owner, new SM_QUESTION_WINDOW(SM_QUESTION_WINDOW.STR_ASK_JOIN_NEW_FACTION, 0, 0, new DescriptionId(activeNpcFactionTemplate.getNameId()),
