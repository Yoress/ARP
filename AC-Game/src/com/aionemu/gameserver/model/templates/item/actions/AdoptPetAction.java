...
/**
 * @author Rolandas
 * @modified Yon (Aion Reconstruction Project) -- Added the configurable ability for players to hatch their own pets.
 */
public class AdoptPetAction extends AbstractItemAction {
	...
	public boolean canAct(Player player, Item parentItem, Item targetItem) {
		return CustomConfig.PLAYER_PET_EGG_INCUBATION;
	}
