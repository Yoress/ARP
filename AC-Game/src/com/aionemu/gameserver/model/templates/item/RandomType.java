...
public enum RandomType {
	...
	MANASTONE_EPIC_GRADE_50(50), // The
								 // EPIC
								 // Manastones:
								 // Ancient
								 // and
								 // Stamp
								 // (Unavailable)
	MANASTONE_EPIC_GRADE_60(60), // The EPIC Manastones: Ancient and Stamp
								 // (Unavailable)
	MANASTONE_EPIC_GRADE_70(70), // The EPIC Manastones: Ancient and Stamp
								 // (Available)
