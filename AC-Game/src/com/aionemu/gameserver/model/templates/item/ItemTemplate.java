...
public class ItemTemplate extends VisibleObjectTemplate {
	...
	public ArmorType getArmorType() {
		if (isPlume()) return ArmorType.PLUME;
		return armorType;
	}
	...
	//TODO: Color warning
	/**
	 * This value is the base max enchant level of the item.
	 * <p>
	 * If you want the real value, call
	 * {@link com.aionemu.gameserver.model.gameobjects.Item#getMaxEnchantLevel() Item.getMaxEnchantLevel()}
	 * instead (from the Item object, instead of this ItemTemplate)!
	 * 
	 * @return The base max enchant level
	 */
	...
	public boolean isAccessory() {
		return category == ItemCategory.EARRINGS || category == ItemCategory.RINGS || category == ItemCategory.NECKLACE || category == ItemCategory.PLUME || category == ItemCategory.HELMET
