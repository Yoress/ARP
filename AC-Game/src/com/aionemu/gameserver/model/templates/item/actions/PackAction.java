		...
		player.getController().addTask(TaskId.ITEM_USE, ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				...
				if (parentItem.getItemTemplate().getItemQuality() != targetItem.getItemTemplate().getItemQuality()) {
					...
					PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_PACK_ITEM_WRONG_TARGET_ITEM_CATEGORY(parentNameId, targetItem.getNameId()));
					return;
				}
				...
				PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402031, new Object[] {new DescriptionId(targetItem.getNameId())}));
			}
		}, 5000));
	}
}
