...
public class EventSystem {
	...
	/**
	 * FFA Map Default : FFAInstance : 320110000 MapID After writing the Map ID , you need to go to here and change this part at top
	 * \AL-Game\data\scripts\system\handlers\instance\FFAInstance.java -- @InstanceID(MAP ID HERE)
	 *
	 * NOTE: Also you need to remove the spawns of the given map ip, By going static_data > spawns > Instances > [mapid_name].xml <-- just remove it
	 * or take backup to desktop Also if that instance has a script file, remove that by going data > script > handlers > ... > .. Instances >
	 * [mapName].java <--- remove it or move to desktop for later use
	 */
	@Property(key = "gameserver.eventsystem.ffa.mapid", defaultValue = "320110000")
	public static int EVENTSYSTEM_FFAMAP;
	
	/**
	 * FFA Map's Spawn Points, You need atleast 10 points X: Y: Z: Float values required
	 */
	...
	/**
	 * After 5th Kill Reward First AP then GP Default : AP = 5000 Default : GP = 150
	 */
	...
	/**
	 * After 10th Kill Reward First AP then GP Default : AP = 7500 Default : GP = 250
	 */
	...
	/**
	 * After 15th Kill Reward First AP then GP Default : AP = 10000 Default : GP = 450
	 */
	...
	/**
	 * After 20th Kill Reward First AP then GP Default : AP = 15000 Default : GP = 650
	 */
	...
	/**
	 * After 25th Kill Reward First AP then GP Default : AP = 20000 Default : GP = 850
	 */
	...
	/**
	 * After 30th Kill Reward First AP then GP Default : AP = 25000 Default : GP = 1000
	 */
	...
	/**
	 * After 35th Kill Reward First AP then GP Default : AP = 30000 Default : GP = 1250
	 */
	...
	/**
	 * After 40th Kill Reward First AP then GP Default : AP = 35000 Default : GP = 1500
	 */
	...
	/**
	 * After 45th Kill Reward First AP then GP Default : AP = 40000 Default : GP = 1750
	 */
	...
	/**
	 * After 50th Kill Reward First AP then GP Default : AP = 50000 Default : GP = 2000
	 */
	...
	/**
	 * After 50 kills and higher First AP then GP Default : AP = 55000 Default : GP = 2250
	 */
	...
	/**
	 * Returning Settings ( .ffa leave) Default : False False - The player will be ported to Pandaemonium/Sanctum True - The player will be ported to
	 * the location where he typed .ffa enter
	 */
	 ...
	 * Item 1
	 */
	@Property(key = "gameserver.onevsone.item1", defaultValue = "166020000") // omega
																			 // item
	 ...
	 * Item 2
	 */
	@Property(key = "gameserver.onevsone.item2", defaultValue = "166030005") // TS
																			 // item
