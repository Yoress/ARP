...
public class AIConfig {
	 ...
	 */
	@Property(key = "gameserver.ai.move.debug", defaultValue = "false")
	...
	/**
	 * Enable the mechanics system.
	 */
	@Property(key = "gameserver.npcmechanics.enable", defaultValue = "true")
	public static boolean MECHANIC_SYSTEM_ENABLED;
	...
	@Property(key = "gameserver.npcmovement.fight.maxwait", defaultValue = "250")
	public static int MAX_FIGHT_MOVE_WAIT_TIME;
