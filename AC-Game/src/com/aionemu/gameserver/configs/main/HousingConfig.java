...
public class HousingConfig {
	...
	public static float BID_REFUND_PERCENT; //FIXME: No longer in use; remove it.
	...
	/**
	 * If true, the number of houses automatically placed up for auction will be limited.
	 * <p>
	 * Default: true
	 */
	@Property(key = "gameserver.housing.auction.fill.auto.limit", defaultValue = "true")
	public static boolean FILL_AUTO_HOUSE_LIMIT_ENABLED;
