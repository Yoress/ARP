...
public class CustomConfig {
	...
	/**
	 * Custom Delay for Hotspot Teleportation Cooldown Time Default: 600 seconds
	 */
	...
	/**
	 * Enables Aion Reconstruction Project Emote Handling. Emoters will face their target, and if
	 * a player protection task is active, it will end. 
	 * <p>
	 * Default: false
	 */
	@Property(key = "gameserver.aion.reconstruction.project.emote.handling", defaultValue = "false")
	public static boolean ARP_EMOTE_HANDLING;
	
	/**
	 * Enables the use of {@link #LOGIN_SERVICE_WELCOME_MESSAGE}.
	 * <p>
	 * Default: true
	 */
	@Property(key = "gameserver.login.welcome.message.enable", defaultValue = "true")
	public static boolean LOGIN_SERVICE_WELCOME_MESSAGE_ENABLED;
	
	/**
	 * Custom message to be displayed when a player enters the world.<br>
	 * Check {@link #LOGIN_SERVICE_WELCOME_MESSAGE_ENABLED} before use.
	 * <p>
	 * Default: Welcome to Aion Lightning
	 */
	@Property(key = "gameserver.login.welcome.message", defaultValue = "Welcome to Aion Lightning")
	public static String LOGIN_SERVICE_WELCOME_MESSAGE;
	
	/**
	 * Custom godstone configuration. Setting this to false will disable godstone skills.
	 * <p>
	 * Default: true
	 */
	@Property(key = "gameserver.godstone.skill.enable", defaultValue = "true")
	public static boolean GODSTONE_SKILL_ENABLED;
	
	/**
	 * Custom config for canceling player blinking on small movements. If set to true, the check on movement
	 * will also include a vertical movement check.
	 * <p>
	 * Default: true
	 */
	@Property(key = "gameserver.blinking.vertical.check.enable", defaultValue = "true")
	public static boolean BLINKING_VERTICAL_CHECK_ENABLED;
	
	/**
	 * Custom config for canceling player blinking on small movements. This value is the allowable vertical
	 * movement -- if {@link #BLINKING_VERTICAL_CHECK_ENABLED} is set to true -- before a player's blinking
	 * is cancelled. Negative values not expected.
	 * <p>
	 * Default: 3.0
	 */
	@Property(key = "gameserver.blinking.vertical.tolerance", defaultValue = "3.0")
	public static float BLINKING_VERTICAL_TOLERANCE;
	
	/**
	 * Custom config for allowing players to hatch their own pet eggs without a pet minder.
	 * <p>
	 * Default: false
	 */
	@Property(key = "gameserver.player.pet.egg.incubation", defaultValue = "false")
	public static boolean PLAYER_PET_EGG_INCUBATION;
	
	/**
	 * Custom config for allowing players to remodel armour items to tiers that are below the item they are remodeling.
	 * Examples: Plate could be skinned to Chain, Leather, or Cloth; Chain to Leather or Cloth but not plate; Leather
	 * to Cloth but not Plate or Chain; Cloth only to Cloth.
	 * <p>
	 * Default: false
	 */
	@Property(key = "gameserver.player.item.remodel.downwards", defaultValue = "false")
	public static boolean DOWNWARDS_ITEM_REMODEL;
}
