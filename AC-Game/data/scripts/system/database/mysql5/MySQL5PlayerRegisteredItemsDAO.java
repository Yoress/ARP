...
public class MySQL5PlayerRegisteredItemsDAO extends PlayerRegisteredItemsDAO {
	...
	public int[] getUsedIDs() {
		PreparedStatement statement = DB.prepareStatement("SELECT item_unique_id FROM player_registered_items WHERE item_unique_id <> 0", ResultSet.TYPE_SCROLL_INSENSITIVE,
