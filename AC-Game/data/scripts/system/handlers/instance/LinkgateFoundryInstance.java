...
public class LinkgateFoundryInstance extends GeneralInstanceHandler {
				...
				public void visit(final Player player) {
					if (player.isOnline()) {
						...
						if (!isStartTimer) {
							...
							PacketSendUtility.sendPacket(player, new SM_QUEST_ACTION(0, 1200)); // 20
																								 // Minutes.
	...
	public void onDropRegistered(Npc npc) {
		...
		case 233887: // Key Keeper
			dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 185000196, 1)); // Abyss
																										 // Gap
																										 // Sealing
																										 // Key
			break;
		case 233898: // Volatile Belsagos.
			dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 188053331, 1)); // Linkgate
																										 // Foundry
																										 // Small
																										 // Ancient
																										 // Manastone
		...
		case 234990: // Wounded Belsagos.
			dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 188053332, 1)); // Linkgate
																										 // Foundry
																										 // Heavy
																										 // Ancient
																										 // Manastone
		...
		case 234991: // Furious Belsagos.
			dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 188053333, 1)); // Linkgate
																										 // Foundry
																										 // Noble
																										 // Ancient
																										 // Manastone
		...
		case 233891: // Thecynon Bruiser.
			dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 164000292, 1)); // Research
																										 // Luminary
																										 // Cloaking
																										 // Scroll.
			break;
		case 234992: // Linkgate Foundry Supply Chest.
			dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 188053238, 1)); // Scroll
																										 // Bundle
																										 // (Linkgate
																										 // Foundry).
			break;
		case 234993: // Linkgate Foundry Supply Chest.
			dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 188053239, 1)); // Scroll
																										 // Bundle
																										 // (Linkgate
																										 // Foundry).
			break;
