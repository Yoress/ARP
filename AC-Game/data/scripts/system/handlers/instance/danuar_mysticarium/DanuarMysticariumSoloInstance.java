...
public class DanuarMysticariumSoloInstance extends GeneralInstanceHandler {
	...
	public void onInstanceCreate(WorldMapInstance instance) {
		...
		/**
		 * Final Boss : The final boss can appear as either a Mage or Fighter balaur, and gives 3010 points when killed. When the Final Boss is dead,
		 * the instance ends and your Grade, stats, and rewards will be presented.
		 */
		int npcId = 0;
		switch (Rnd.get(1, 2)) {
		case 1:
