...
public class AsteriaInstance extends GeneralInstanceHandler {
	...
	private void spawnRings() {
		FlyRing f1 = new FlyRing(new FlyRingTemplate("ASTERIA_WING_1", mapId, new Point3D(479.24, 572.57, 202.72), new Point3D(477.95, 567.64, 212.9), new Point3D(477.97, 563.35, 202.12), 10),
				instanceId);
		f1.spawn();
	}
