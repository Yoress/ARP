...
//		Player player = npc.getAggroList().getMostPlayerDamage();
		...
		case 284857: // Beritra Healer.
			beritraKilled++;
			if (beritraKilled == 1) {} else if (beritraKilled == 2) {} else if (beritraKilled == 3) {} else if (beritraKilled == 4) {
		...
		case 234686: // Test Weapon Dynatoum.
			...
			spawn(730905, 240.2449f, 254.58f, 455.12012f, (byte) 0); // Illuminary
																	 // Obelisk
																	 // Exit.
			break;
		}
	...
	public boolean onDie(final Player player, Creature lastAttacker) {
		// PacketSendUtility.sendPacket(player, new SM_QUEST_ACTION(0, 360 -
		// (int) time / 1000));
