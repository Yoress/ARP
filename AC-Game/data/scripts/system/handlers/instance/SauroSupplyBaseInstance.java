...
/**
 * Author boscar Author yayaya Author NightRider Author Ever
 *
 * :: 1. boss : Guard Captain Rohuka 1.BOSS , 1.door (230849) >> Door ID : 383 :: 2. boss : Chief Gunner Kurmata 2.BOSS (230851) >> room, door ID :
 * 382 (left), 387 (right) :: Door NPC : Sheban Legion Elite Ambusher (230797) >> door ID : 59 :: 3. boss : Derakanak the Reaver 3.BOSS (233258) ::
 * Prison : 373, 380, 377 (left) ; 384, 374 (right) :: Door NPC : Sheban Legion Elite Gunner (230818) >> door ID : 372 :: 4. boss : Researcher Teselik
 * (230850) >> Door ID : 375 :: 5. boss : Gatekeeper Stranir (233255) >> Door ID : 378 :: 6. boss : Commander Ranodim (230852) >> Door ID : 388 ::
 * Door ID : Blue : 385 (key : 185000177), Red 379 (key : 185000176), Green : 381 (key : 185000178) :: 7/1. boss: Archmagus Sayahum (233257) :: 7/2.
 * boss: Darkblade Ovanuka (233256) :: Ajto NPC : Sheban Legion Elite Assaulter (230791) >> Door ID : 376 :: Port NPC : 8. boss : Chief of Staff
 * Moriata (230853) :: Portal : (730872) ; Portal key : 185000179 :: 1 KEY : Guard Leader Achradim (230857) :: 2 KEY : Brigadian General Sheba
 * (230858)
 *
 */
...
//	private boolean isInstanceDestroyed;
	...
	public void onDie(Npc npc) {
		...
		case 230853: // Staff Commander Moriata
			sendMsg(1401921);
			spawn(730872, 129.16f, 432.33f, 153.33f, (byte) 0, 3); // portal to
																	 // boss
			break;
		...
		case 230858: // Brigadian General Sheba , 2 key boss
			spawn(801967, 886.4798f, 876.16693f, 411.45676f, (byte) 15); // exit
																		 // portal
			spawn(702659, 897.20306f, 886.9926f, 411.57693f, (byte) 15); // Noble
																		 // Abbey
																		 // Box
			scheduleExit();
			break;
