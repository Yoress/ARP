...
public class DanuarReliquaryInstance extends GeneralInstanceHandler {
	...
	public void onEnterInstance(Player player) {
		...
		/**
		 * WTF IS THIS ? Remove NPC ID effect ? LOL :D player.getEffectController().removeEffect(218611);
	...
	public void onDie(Npc npc) {
		...
		case 284382:
			...
			break;
		case 284383:
			CQM1.getController().onAttack(CQM1, 125000, true, null);
			CloneKill++;
			CloneCount++;
		...
		case 231305:
			...
			/*
			 * sendMsg(1401893); despawnNpc(npc); spawn(730843, 256.2082f, 250.2959f, 241.8779f, (byte) 30); //exit spawn(701795, 256.5212f,
			 * 258.3195f, 241.7859f, (byte) 89); //treasure box
			 */
			break;
		case 284659:
