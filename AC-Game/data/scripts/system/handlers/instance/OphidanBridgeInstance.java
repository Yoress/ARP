...
public class OphidanBridgeInstance extends GeneralInstanceHandler implements PlayerController.Listener {
	...
	public void onInstanceCreate(WorldMapInstance instance) {
		...
		spawn(230413, 476.74689f, 523.6272f, 598.8186f, (byte) 13); // GENERATEUR
																	 // POST
																	 // (230417)
		spawn(230414, 524.53607f, 427.29379f, 621.82062f, (byte) 15); // GENERATEUR
																		 // NORD
																		 // (230418)
		spawn(230415, 602.40997f, 556.41998f, 592.16406f, (byte) 113); // GENERATEUR
																		 // SUD
																		 // (230419)
		spawn(230416, 666.76001f, 474.20999f, 601.1673f, (byte) 117); // GENERATEUR
																		 // Defense
																		 // (230420)
	...
	public void onEnterInstance(Player player) {
		...
		if (player.getRace() == Race.ELYOS) {
			...
			if (entrance == 1) {
				spawn(701646, 763.51685f, 533.11804f, 576.5853f, (byte) 59);// TANK
																			// ELYOS
			...
			if (entrance == 1) {
				spawn(701647, 763.51685f, 533.11804f, 576.5853f, (byte) 59); // TANK
																			 // ASMO
	...
	public void onDie(Npc npc) {
		...
		case 230413:
			sendMsg(1401904);
			spawn(230417, 476.74689f, 523.6272f, 598.8186f, (byte) 13); // Disabled
																		 // GENERATEUR
																		 // POST
			despawnNpc(npc);
			Powerdevice++;
			...
			break;
		case 230417:
			spawn(230413, 476.74689f, 523.6272f, 598.8186f, (byte) 13); // Balaur
																		 // GENERATEUR
																		 // POST
			despawnNpc(npc);
			break;
		case 230414:
			sendMsg(1401905);
			spawn(230418, 524.53607f, 427.29379f, 621.82062f, (byte) 15); // Disabled
																			 // GENERATEUR
																			 // NORD
			despawnNpc(npc);
			Powerdevice++;
			...
			break;
		case 230418:
			spawn(230414, 524.53607f, 427.29379f, 621.82062f, (byte) 15); // balaur
																			 // GENERATEUR
																			 // NORD
			despawnNpc(npc);
			break;
		case 230415:
			sendMsg(1401906);
			spawn(230419, 602.40997f, 556.41998f, 592.16406f, (byte) 113); // Disabled
																			 // GENERATEUR
																			 // SUD
			despawnNpc(npc);
			Powerdevice++;
			...
			break;
		case 230419:
			spawn(230415, 602.40997f, 556.41998f, 592.16406f, (byte) 113); // balaur
																			 // GENERATEUR
																			 // SUD
			despawnNpc(npc);
			break;
		case 230416:
			sendMsg(1401907);
			spawn(230420, 666.76001f, 474.20999f, 601.1673f, (byte) 117); // Disabled
																			 // GENERATEUR
																			 // Defense
			despawnNpc(npc);
			Powerdevice++;
		...
		case 230420:
			...
			spawn(230416, 666.76001f, 474.20999f, 601.1673f, (byte) 117); // balaur
																			 // GENERATEUR
																			 // Defense
			despawnNpc(npc);
			break;
