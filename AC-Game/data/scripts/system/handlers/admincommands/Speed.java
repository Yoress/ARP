...
/**
 * @author ATracer
 * @reworked Yondomie (Changed //speed 0 to handle base speed not being 6)
 */
public class Speed extends AdminCommand implements StatOwner {
	...
	public void execute(Player admin, String... params) {
		...
		if (parameter == 0) {
			admin.getGameStats().endEffect(this, false);
		} else {
			admin.getGameStats().endEffect(this, false);
			...
			admin.getGameStats().addEffect(this, functions, false);
		}
