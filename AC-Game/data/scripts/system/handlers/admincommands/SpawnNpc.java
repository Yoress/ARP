 ...
 * @modified Yon (Aion Reconstruction Project) -- Changed keyword to sp.
 */
public class SpawnNpc extends AdminCommand {
	...
	public void execute(Player admin, String... params) {
		if (params.length < 1) {
			PacketSendUtility.sendMessage(admin, "syntax //sp <template_id> <respawn_time> [<x> <y> <z> <h>] (0 for temp)");
			return;
		}
	...
	public void onFail(Player player, String message) {
		PacketSendUtility.sendMessage(player, "syntax //sp <template_id> <respawn_time> (0 for temp)");
	}
}
