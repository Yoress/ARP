...
public class cmd_support extends PlayerCommand {
	...
	public void execute(Player player, String... params) {
		if (params.length == 0) {
			PacketSendUtility.sendMessage(player, "Syntax: .support <Issue Short Description> -- will notify GM's of your issue");
			return;
		}
	...
	public void peek(Player player) {
		...
		IssueMsg.append("=============================\n");
		IssueMsg.append("From: " + support.getOwner().getName() + ":" + support.getOwner().getLevel() + ":" + support.getOwner().getRace().toString() + ":"
