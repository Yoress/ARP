...
/**
 * @author Eloann
 * @modified Yon (Aion Reconstruction Project) -- Added a distinction between category-based drop groups and non-category-based drop groups.
 */
public class cmd_drop extends PlayerCommand {
	...
	public void execute(Player player, String... params) {
		...
		for (DropGroup dropGroup : npcDrop.getDropGroup()) {
			PacketSendUtility.sendMessage(player, "DropGroup: " + dropGroup.getGroupName() + (dropGroup.isUseCategory() ? " [ONE RANDOM ROLL]" : ""));
