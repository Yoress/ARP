...
public class _28602IntotheUnknown extends QuestHandler {
	...
	// Changed if Player didnt kill NPC's 217002 217000 216982 Instance will
	// spawn 217006 for this Quest we need 217005
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {
			...
			if (targetId == 205234) {
				if (env.getDialog() == DialogAction.QUEST_SELECT) {
					...
					// if
					// (!player.getPortalCooldownList().isPortalUseDisabled(300230000))
					// { //CHECK COOLDOWN
					...
					// //CHECK COOLDOWN
					// DataManager.INSTANCE_COOLTIME_DATA.getInstanceEntranceCooltime(player,
					// newInstance.getMapId())); //CHECK COOLDOWN
