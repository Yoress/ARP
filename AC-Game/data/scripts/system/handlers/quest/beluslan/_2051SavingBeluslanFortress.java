 ...
 * @modified Yon (Aion Reconstruction Project) -- Added a teleport upon interacting with NPC 700284.
 */
		...
		if (targetId == 204702) {
			...
			case USE_OBJECT:
				if (var == 11) {
					...
					TeleportService2.teleportTo(player, 220040000, 393.52637F, 356.2794F, 211.50677F, (byte) 8);
