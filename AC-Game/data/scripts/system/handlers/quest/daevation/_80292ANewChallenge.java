...
public class _80292ANewChallenge extends QuestHandler {
	...
	private final static int items[] = {110601356, 113601308, 114601305, 112601299, 111601319, 110301409, 113301374, 114301409, 112301293, 111301350, 110101513, 113101375, 114101403, 112101312,
										111101358, 110501382, 113501355, 114501363, 112501280, 111501340, 110301669, 113301638, 114301673, 112301546, 111301607};
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {
			...
			if (targetId == 831385) {
				...
				case 10002:
				case 10003: {
					if (player.getInventory().getItemCountByItemId(186000041) < 10) return sendQuestDialog(env, 1009);
