 ...
 * @author Gigi
 * @author vlog
 * @modified Yon (Aion Reconstruction Project) -- Removed improper handling because it was irrelevant (misuse of sendQuestSelectionDialog(QuestEnv)).
 */
...
//						//TO-DO: What is this supposed to do? This would look like the input was ignored to the player.
//						//It's not possible to trigger this on a 4.7.5.18 client by selecting this quest.
...
//				case FINISH_DIALOG: {
//					//Don't leave the quest dialog open when finished talking!
//					//This case cannot be triggered with a 4.7.5.18 client; the client sends CM_CLOSE_DIALOG, which is handled differently.
//					return sendQuestSelectionDialog(env);
//				}
				}
				break;
