 ...
 * @author vlog
 * @author Antraxx
 * @modified Yon (Aion Reconstruction Project) -- Closed the Dialog when finished talking with the NPC.
 */
...
//						return sendQuestSelectionDialog(env);
						return defaultCloseDialog(env, 9, 9); //Don't leave the dialog open!
					}
				}
				case FINISH_DIALOG: {
