...
public class _22562ButItWasAMagicRock extends QuestHandler {
	...
	public HandlerResult onItemUseEvent(final QuestEnv env, Item item) {
		...
		if (id != 182213362) return HandlerResult.UNKNOWN;
		
		if (qs == null || qs.getStatus() != QuestStatus.START) return HandlerResult.UNKNOWN;
		
		if (qs.getQuestVarById(0) != 0) return HandlerResult.UNKNOWN;
		
		if (!player.isInsideZone(ZoneName.get("LDF5A_ITEMUSEAREA_Q12562"))) return HandlerResult.UNKNOWN;
