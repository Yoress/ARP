...
public class _22566HildanonLegacy extends QuestHandler {
	...
	public HandlerResult onItemUseEvent(final QuestEnv env, Item item) {
		...
		if (id != 182213365) return HandlerResult.UNKNOWN;
		
		if (qs == null || qs.getStatus() != QuestStatus.START) return HandlerResult.UNKNOWN;
		
		if (qs.getQuestVarById(0) != 1) return HandlerResult.UNKNOWN;
		
		if (!player.isInsideZone(ZoneName.get("LDF5A_SENSORYAREA_Q22566_206323_11_600050000"))) return HandlerResult.UNKNOWN;
