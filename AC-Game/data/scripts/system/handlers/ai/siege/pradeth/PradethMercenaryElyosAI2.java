...
public class PradethMercenaryElyosAI2 extends NpcAI2 {
	...
	public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
		...
		case SETPRO2:
			...
			break;
		case SETPRO3:
			spawn(273314, 2596.982f, 2737.708f, 266.19125f, (byte) 46); // Empty
																		 // Aetheric
																		 // Bombard
			spawn(273314, 2611.173f, 2752.241f, 266.19125f, (byte) 45); // Empty
																		 // Aetheric
																		 // Bombard
			spawn(273314, 2705.3672f, 2636.0967f, 266.20126f, (byte) 106); // Empty
																			 // Aetheric
																			 // Bombard
			spawn(273314, 2718.9968f, 2651.4675f, 266.20126f, (byte) 105); // Empty
																			 // Aetheric
																			 // Bombard
			break;
		}
