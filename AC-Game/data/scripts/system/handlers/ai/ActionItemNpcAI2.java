 ...
 * @modified Yon (Aion Reconstruction Project) -- removed support for QuestBusy Npc's.
 */
@AIName("useitem")
public class ActionItemNpcAI2 extends NpcAI2 {
	...
	protected void handleUseItemStart(final Player player) {
		...
		//Support for that garbage was removed (it was only used in one place, and it wasn't even correct).
