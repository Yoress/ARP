...
public class HamerunTheBleederAI2 extends AggressiveNpcAI2 {
	...
	private void spawnServants() {
		...
		// Spawns Brainwashed Fighter [ID: 282041] and Brainwashed MuMu Fighter
		// [ID: 282042]
			...
			if (hpPercentage <= percent) {
				...
				case 50:
					...
					if (!isAlreadyDead() && phase.equals(Phase.ACTIVE)) {
						// Stops Ability Drain task to avoid to stop him without
						// shield as actually two buffs cannot be got together
						taskAbilityDrainStop();
