...
public class Recordkeeper2AI2 extends NpcAI2 {
	...
	public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
		...
		if (dialogId == 10000) {
			...
			// SM_SYSTEM_MESSAGE(1401586));
			// break;
			case 831110: // Stage 1.
				spawn(219483, 410.8536f, 411.2721f, 376.33743f, (byte) 0);
				skillId = player.getRace() == Race.ASMODIANS ? 21103 : 21094; // Ancient
																				 // Shugo
																				 // Warrior
																				 // Form
				SkillEngine.getInstance().applyEffectDirectly(skillId, player, player, 0); // Ancient
																							 // Shugo
																							 // Warrior
																							 // Form
				...
				// spawn tower
				spawn(831130, 170.58615f, 224.70198f, 535.81213f, (byte) 15); // Crown
																				 // Prince's
																				 // Tombstone.
				spawn(831250, 186.37216f, 226.88597f, 535.81213f, (byte) 15); // Royal
																				 // Tomb
																				 // Stone
																				 // Tower.
				spawn(831250, 169.97723f, 239.81743f, 535.812133f, (byte) 15); // Royal
																				 // Tomb
																				 // Stone
																				 // Tower.
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					...
					public void run() {
						// Left path
						startWalk((Npc) spawn(219632, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Diligent
																													 // Kobold
																													 // Worker.
						startWalk((Npc) spawn(219632, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Diligent
																													 // Kobold
						...
						// Right path
						startWalk((Npc) spawn(219632, 225.52513f, 279.42987f, 550.68805f, (byte) 78), "3005600002"); // Diligent
																													 // Kobold
																													 // Worker.
						startWalk((Npc) spawn(219632, 225.52513f, 279.42987f, 550.68805f, (byte) 78), "3005600002"); // Diligent
																													 // Kobold
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					...
					public void run() {
						...
						startWalk((Npc) spawn(219632, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Diligent
																													 // Kobold
																													 // Worker.
						startWalk((Npc) spawn(219633, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Kobold
																													 // Foreman.
						...
						startWalk((Npc) spawn(219632, 225.52513f, 279.42987f, 550.68805f, (byte) 78), "3005600002"); // Diligent
																													 // Kobold
																													 // Worker.
						startWalk((Npc) spawn(219633, 225.52513f, 279.42987f, 550.68805f, (byte) 78), "3005600002"); // Kobold
																													 // Foreman.
					}
				}, 15000);
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					...
					public void run() {
						...
						// TODO: Message "More pillagers will arrive in 5
						// seconds!"
					}
				}, 20000);
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					...
					public void run() {
						...
						startWalk((Npc) spawn(219633, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Kobold
																													 // Foreman.
						startWalk((Npc) spawn(219638, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Strong
																													 // Kobold
																													 // Worker.
						...
						startWalk((Npc) spawn(219633, 225.52513f, 279.42987f, 550.68805f, (byte) 78), "3005600002"); // Kobold
																													 // Foreman.
						startWalk((Npc) spawn(219638, 225.52513f, 279.42987f, 550.68805f, (byte) 78), "3005600002"); // Strong
																													 // Kobold
																													 // Worker.
					}
				}, 50000);
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					...
					public void run() {
						// Left path
						startWalk((Npc) spawn(219629, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Tomb
																													 // Ghost.
						
						// Center path
						startWalk((Npc) spawn(219924, 218.11357f, 287.34048f, 550.68805f, (byte) 78), "3005600003"); // Awakened
																													 // Guardian
																													 // Tomb
																													 // Ghost.
						
						// Right path
						startWalk((Npc) spawn(219629, 225.52513f, 279.42987f, 550.68805f, (byte) 78), "3005600002"); // Tomb
																													 // Ghost.
					}
				}, 55000);
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					...
					public void run() {
						...
						startWalk((Npc) spawn(219633, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Kobold
																													 // Foreman.
						startWalk((Npc) spawn(219639, 211.19382f, 294.39218f, 550.68805f, (byte) 78), "3005600001"); // Strong
																													 // Kobold
																													 // Foreman.
																													 // //TODO
																													 // AI2
