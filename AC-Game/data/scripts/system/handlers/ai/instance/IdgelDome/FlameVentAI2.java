...
public class FlameVentAI2 extends ActionItemNpcAI2 {
	...
	private final int FlameLeversSpawnTime = 2 * 60 * 1000;// Every 2-minutes
															// flame levers will
															// be spawned (NA
															// Retail v4.7.5.17)
	...
	protected void handleUseItemFinish(Player player) {
		...
		case 802192: // Flame Vent (Elyos).
			...
			sp(702405, 232.19067f, 185.85762f, 80.2f, (byte) 75, 0);// Enchanted
																	// Book
																	// (IDLDF5_Fortress_Re_Fire_Fxmon_02)
			sp(702405, 238.54938f, 200.84813f, 80.0f, (byte) 15, 0);// Enchanted
																	// Book
																	// (IDLDF5_Fortress_Re_Fire_Fxmon_02)
			sp(702387, 198.19942f, 190.41037f, 85.757484f, (byte) 13, 143, 0, 0, null);// Enchanted
																						// Book
																						// (IDLDF5_Fortress_Re_SetFOBJ_01)
			sp(855010, 234.4599f, 194.21619f, 79.23065f, (byte) 0, 0);// Repelling
																		// Flame
																		// Cannon
			/*
		...
		case 802549: // Flame Vent (Asmo)
			analyzeOpening(player);
			sp(702405, 290.67102f, 317.26324f, 80.1f, (byte) 75, 0);// Enchanted
																	// Book
																	// (IDLDF5_Fortress_Re_Fire_Fxmon_02)
			sp(702405, 297.08356f, 332.35382f, 80.1f, (byte) 15, 0);// Enchanted
																	// Book
																	// (IDLDF5_Fortress_Re_Fire_Fxmon_02)
			sp(702388, 331.23566f, 327.82135f, 85.44032f, (byte) 13, 14, 0, 0, null);// Enchanted
																						// Book
																						// (IDLDF5_Fortress_Re_SetFOBJ_02)
			sp(855010, 294.62436f, 324.11783f, 79.230644f, (byte) 0, 0);// Repelling
																		// Flame
																		// Cannon
			/*
		...
		ConcurrentTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				if (getOwner().getRace() == Race.ELYOS) {
					sp(802192, 199.1874f, 191.76154f, 80.602165f, (byte) 15, 0);// ...Flame
																				// Vent
																				// Elyos
				} else if (getOwner().getRace() == Race.ASMODIANS) {
					sp(802549, 329.79938f, 326.1139f, 80.60217f, (byte) 75, 0);// .....Flame
																				// Vent
																				// Asmodian
				}
