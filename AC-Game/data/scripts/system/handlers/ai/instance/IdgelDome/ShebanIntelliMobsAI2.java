...
public class ShebanIntelliMobsAI2 extends AggressiveNpcAI2 {
	...
	protected void handleSpawned() {
		...
		case 234754:// Sheban Elite Medic
			...
			if (rand == 1) {
				...
				apllyEffect(20700, getOwner());// Midnight Robe
												// (PHYSICAL_DEFENSE,
												// MAGICAL_DEFEND += 200)
			}
			break;
	 ...
	 * 
	 * Sheban Intelligent Unit Mongrel Sheban Elite Marauder
	 */
	 ...
	 * Select Random Skills for:
	 * 
	 * Sheban Intelligent Unit Ridgeblade Sheban Elite Stalwart
	 */
	 ...
	 * Select Random Skills for:
	 * 
	 * Sheban Intelligent Unit Stitch Sheban Elite Medic
	 */
	 ...
	 * Select Random Skills for:
	 * 
	 * Sheban Intelligent Unit Hunter Sheban Elite Sniper
	 */
	...
	private void apllyEffect(int skillId, Creature target) {
		// SkillEngine.getInstance().applyEffectDirectly(skillId, getOwner(),
		// target, 0);
