...
public class Northern_Shield_GeneratorAI2 extends NpcAI2 {
	...
	/**
	 * The higher the phase of the charge will spawn more difficult monsters, in the 3rd phase elite monsters will spawn. Charging a shield to the 3rd
	 * phase continuously can be hard because of all the mobs you will have to handle. A few easy monsters will spawn after a certain time if you
	 * leave the shield unit alone. After all units have been charged to the 3rd phase, defeat the remaining monsters. ***************************
