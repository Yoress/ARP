 ...
 * <p/>
 * public void handleRead(ResultSet rset) throws SQLException { while (rset.next()) { // Usually here in the custom class you would set it to your
 ...
 * <p/>
 * public void handleInsertUpdate(PreparedStatement stmt) { // Usually this would be data from the custom class that implements IUSth String[]
