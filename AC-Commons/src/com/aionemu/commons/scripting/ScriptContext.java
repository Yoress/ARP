...
public interface ScriptContext {
	...
	/**
	 * Adds child contexts to this context. If this context is initialized - chiled context will be initialized immideatly. In other case child
	 * context will be just added and initialized when {@link #init()} would be called. Duplicated child contexts are not allowed, in such case child
	 * will be ignored
	 *
